...
# alpha_beta vs alpha_beta player (with heuristic)
#player_a, player_b = player_alphabeta3_h, player_alphabeta4_h

# alpha_beta vs alpha_beta player (with heuristic2)
player_a, player_b = player_alphabeta3_h2, player_alphabeta4_h2
